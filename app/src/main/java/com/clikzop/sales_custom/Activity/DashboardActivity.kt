...
class DashboardActivity : AppCompatActivity(), ApiResponseListner {
    ...
    private fun getMaster(): ArrayList<MenuModelBean> {
        var menuList = ArrayList<MenuModelBean>()
        menuList.add(MenuModelBean(1, "Insert Consultant", "", R.drawable.ic_dashbord))
        //  menuList.add(MenuModelBean(2, "Insert Installer", "", R.drawable.ic_dashbord))
        menuList.add(MenuModelBean(2, "Insert Contractor", "", R.drawable.ic_dashbord))
        ...
        menuList.add(MenuModelBean(7, "Consultant", "", R.drawable.ic_dashbord))
        menuList.add(MenuModelBean(8, "Contractor", "", R.drawable.ic_dashbord))
    ...
    private fun getMenusReports(): ArrayList<MenuModelBean> {
        ...
        menuList.add(MenuModelBean(1, "Consultant Report", "", R.drawable.ic_dashbord))
        menuList.add(MenuModelBean(2, "Contractor Report", "", R.drawable.ic_dashbord))
